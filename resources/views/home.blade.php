...
<body class="bg-gray-100 dark:bg-gray-900 transition-colors duration-300" x-data="{ darkMode: false, cartOpen: false }">
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow ">
            ...
            <div x-data="{ activeSlide: 1 }" class="relative bg-transparent  overflow-hidden" style="background-image: url('https://picsum.photos/id/{{ rand(1,1000) }}/1600/800')">
                <div class="max-w-8xl mx-auto">
                    <div class="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div class="sm:text-center lg:text-left bg-transparent bg-slate-200">
                                <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                                    <span class="block xl:inline text-gray-900 dark:text-white">BoutiqueChic</span>
                                    <span class="block text-indigo-600 xl:inline">Votre style, notre passion</span>
                                </h1>
                                <p class="mt-3 text-base text-gray-900 dark:text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
