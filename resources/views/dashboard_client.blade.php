    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white dark:bg-gray-800 shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tableau de bord <span class="text-indigo-600 dark:text-indigo-400">Client {{ Auth::user()->name }}</span> </h1>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg mb-8">
                    <div class="p-5 flex justify-between items-center">
                        <div>
                            <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">Modifier le profil</h3>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Gérez vos informations personnelles</p>
                        </div>
                        <button @click="profileEdit = !profileEdit" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-600">
                    ...
                    <div x-show="profileEdit" class="p-5 border-t border-gray-200 dark:border-gray-700">
                        <form class="space-y-4">
                            <div>
                                ...
                                <input type="text" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Email</label>
                                <input type="email" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Mot de passe</label>
                                <input type="password" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg mb-8">
                    <div class="p-5">
                        ...
                        <div class="mt-4">
                            <ul class="space-y-4">
                                <li class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md shadow-sm flex items-center justify-between">
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-900 dark:text-white">Commande #12345</h4>
                                    ...
                                    <button class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-600">
                                        Voir détails
                                    </button>
                                </li>
                                <!-- Autres commandes... -->
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-4">
                            <ul class="space-y-4">
                                <li class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md shadow-sm flex items-center justify-between">
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-900 dark:text-white">T-shirt Premium</h4>
                        ...
                        <div class="mt-4">
                            <form class="space-y-4">
                                <div>
                                    ...
                                    <select class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                        <option>T-shirt Premium</option>
                                        <!-- Autres produits... -->
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Votre avis</label>
                                    <textarea rows="4" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300"></textarea>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Note</label>
                                    <div class="flex items-center">
                                        <input type="number" min="1" max="5" class="mt-1 block w-20 shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
