...
<div class=" bg-white shadow-lg rounded-lg p-4 m-10">
    ...
    <div class="mb-4">
        ...
        <p class="text-gray-600">{{ $commande->adresse->nom_adresse }}, {{ $commande->adresse->adresse }}, {{ $commande->adresse->ville }}, {{ $commande->adresse->code_postal }}, {{ $commande->adresse->pays }}</p>
    </div>
    <div class="mb-4">
    ...
    <div class="mb-4 text-right mr-8">
        ...
        <p class="text-gray-600 text-2xl font-bold">{{ $commande->total }} €</p>
    </div>
    <div class="mb-4">
