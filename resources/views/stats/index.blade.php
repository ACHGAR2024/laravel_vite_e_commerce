            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-3xl font-semibold text-gray-900 dark:text-white">{{ number_format($totalSales, 2, ',', ' ') }} €</dd>
                    </dl>
                </div>
            </div>
        </div>
                ...
                <ul class="mt-4 space-y-4">
                    @foreach($recentProducts as $product)
                        <li class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600 dark:text-gray-300">{{ $product->id }}</span>
                        </li>
                    @endforeach
                </ul>
            </div>
