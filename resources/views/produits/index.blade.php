    ...
    <div class="max-w-7xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-6 space-y-4">
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('produits.create') }}" class="bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-500 hover:to-blue-600 text-white font-bold py-2 px-4 rounded-full inline-flex items-center transition duration-300">
                    <i class="fas fa-plus-circle mr-2"></i>
                    Créer un produit
                </a>
                <a href="{{ route('categories.create') }}" class="bg-gradient-to-r from-yellow-400 to-red-500 hover:from-yellow-500 hover:to-red-600 text-white font-bold py-2 px-4 rounded-full inline-flex items-center transition duration-300">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $produit->id }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <a href="{{ route('photos.index', $produit->id) }}" class="text-black hover:text-gray-700 mr-3">
